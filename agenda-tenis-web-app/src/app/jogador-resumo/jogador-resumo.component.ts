...
import { JogadorResumoService, JogadorResumo } from './jogador-resumo.service';
...
export class JogadorResumoComponent implements OnInit {
  ...
  constructor(private jogadorResumoService: JogadorResumoService) {}

  ngOnInit(): void {
    this.jogadorResumoService.obterResumo().subscribe(
      (resumo) => {
